...
#import <Foundation/Foundation.h>
 @protocol RNFileDownloadDelegate;
@interface RNFileDownLode : NSObject
{    
    __unsafe_unretained id<RNFileDownloadDelegate> delegate;      
    BOOL       overwrite;                        
    NSURL      *url;
    NSString   *fileName;
    NSString   *filePath;
...
@property (nonatomic, assign) id<RNFileDownloadDelegate> delegate;
/*
...
@protocol RNFileDownloadDelegate<NSObject>
@optional
//下载开始(responseHeaders为服务器返回的下载文件的信息)
- (void)downloadBegin:(RNFileDownLode *)aDownload didReceiveResponseHeaders:(NSURLResponse *)responseHeaders;
//下载失败
