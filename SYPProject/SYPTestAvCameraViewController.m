//
//  SYPTestAvCameraViewController.m
//  SYPProject
//
...
@interface SYPTestAvCameraViewController ()
{
    NSArray *paths;
    int filterIndex;
...
@implementation SYPTestAvCameraViewController
...
{
    [super viewDidLoad];
    self.cameraView = [[[XBFilteredCameraView alloc] initWithFrame:CGRectMake(0, 0, 320, 640)] autorelease];
    self.cameraTargetView = [[[CameraTargetView alloc] initWithFrame:CGRectMake(20, 20, 100, 100)] autorelease];
