...
#define kTXaccessTokenKey   @"TXaccessToken"
#define kTXaccessSecretKey  @"TXaccessSecret"
#define kTXopenidKey        @"TXopenid"
#define kTXopenkeyKey       @"TXopenkey"
#define kTXexpireDateKey    @"TXexpireDate"
//
