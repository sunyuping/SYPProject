...
@synthesize publishParams = _publishParams;
...
- (void) publishWeibo:(NSString *)weiboContent jing:(NSString *)jing wei:(NSString *)wei format:(NSString *)format clientip:(NSString *)clientip syncflag:(NSString *)syncflag {
    ...
    self.publishParams = [NSMutableDictionary dictionary];
    ...
    if (self.retCode == resSuccessed) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"TencentSendWeiboSuccessed" object:nil];
    }
    else {
