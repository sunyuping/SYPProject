...
- (void)layoutText:(TTStyledTextNode*)textNode container:(TTStyledElement*)element {
  ...
  if (!textNode.nextSibling && textNode == _rootNode) {
    ...
    // Modified by Cloud at 20110303
    //NSCharacterSet* whitespace = [NSCharacterSet whitespaceAndNewlineCharacterSet];
    NSMutableCharacterSet *whitespace = [NSMutableCharacterSet whitespaceAndNewlineCharacterSet];
    [whitespace addCharactersInRange:NSMakeRange(0x4E00, 0x9FA5)];
	[whitespace addCharactersInRange:NSMakeRange(0xF900, 0xFA2D)];
	[whitespace addCharactersInRange:NSMakeRange(0x0000, 0x002F)];
