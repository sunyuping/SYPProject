...
#import "CYToasterFilter.h"

NSString *const kCYToasterShaderString = SHADER_STRING
(
...
@implementation CYToasterFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kCYToasterShaderString]))
    {
		return nil;
    }
	
	[self.pictureImagePaths addObject:@"toasterMetal"];
	[self.pictureImagePaths addObject:@"toasterSoftLight"];
	[self.pictureImagePaths addObject:@"toasterCurves"];
	[self.pictureImagePaths addObject:@"toasterOverlayMapWarm"];
	[self.pictureImagePaths addObject:@"toasterColorShift"];
    return self;
}
