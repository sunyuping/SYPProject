...
#import "CYEarlybirdFilter.h"
NSString *const kCYEarlybirdShaderString = SHADER_STRING
(
 ...
 void main()
 {
     ...
     vec3 texelyiyi = texture2D(inputImageTexture, textureCoordinate).rgb;
...
@implementation CYEarlybirdFilter
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kCYEarlybirdShaderString]))
    {
		return nil;
    }
	
	[self.pictureImagePaths addObject:@"earlyBirdCurves"];
    [self.pictureImagePaths addObject:@"earlybirdOverlayMap"];
    [self.pictureImagePaths addObject:@"vignetteMap"];
    [self.pictureImagePaths addObject:@"earlybirdBlowout"];
    [self.pictureImagePaths addObject:@"earlybirdMap"];
