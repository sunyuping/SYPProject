...
#import "CYSutroFilter.h"

NSString *const kCYSutroShaderString = SHADER_STRING
(
...
@implementation CYSutroFilter
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kCYSutroShaderString]))
    {
		return nil;
    }
	[self.pictureImagePaths addObject:@"vignetteMap"];
	[self.pictureImagePaths addObject:@"sutroMetal"];
	[self.pictureImagePaths addObject:@"softLight"];
	[self.pictureImagePaths addObject:@"sutroEdgeBurn"];
	[self.pictureImagePaths addObject:@"sutroCurves"];
