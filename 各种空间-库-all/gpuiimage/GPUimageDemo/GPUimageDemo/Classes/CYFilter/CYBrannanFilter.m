...
#import "CYBrannanFilter.h"
NSString *const kCYBrannanShaderString = SHADER_STRING
(
...
@implementation CYBrannanFilter


- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kCYBrannanShaderString]))
    {
		return nil;
    }
	[self.pictureImagePaths addObject:@"brannanProcess"];
    [self.pictureImagePaths addObject:@"brannanBlowout"];
    [self.pictureImagePaths addObject:@"brannanContrast"];
    [self.pictureImagePaths addObject:@"brannanLuma"];
    [self.pictureImagePaths addObject:@"brannanScreen"];
