...
#import "CYValenciaFilter.h"
NSString *const kCYValenciaShaderString = SHADER_STRING
(
...
@implementation CYValenciaFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kCYValenciaShaderString]))
    {
		return nil;
    }

	[self.pictureImagePaths addObject:@"valenciaMap"];
	[self.pictureImagePaths addObject:@"valenciaGradientMap"];
